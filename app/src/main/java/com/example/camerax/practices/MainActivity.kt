...
import com.example.camerax.practices.ui.theme.CameraXPracticesTheme
            ...
            when(event) {
                is VideoRecordEvent.Finalize -> {
                    if (event.hasError()) {
                        ...
                        Toast.makeText(applicationContext, "Video capture succeed", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
